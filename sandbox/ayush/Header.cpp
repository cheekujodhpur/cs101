...
using namespace std;
using namespace cv;
string face_cascade_name = "/home/cheeku/Projects/opencv-2.4.9/data/haarcascades/haarcascade_frontalface_alt.xml";//location of face detector in haar cascades
